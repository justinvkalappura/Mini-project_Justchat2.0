...
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;
    <div class="nav-grid--box--search--search" style="margin-top: 534px;">
                            <i class="nav-grid--box--search--search--input--icon fa-1x fa-solid fa-magnifying-glass"></i>
                            <input class="nav-grid--box--search--search--input" placeholder="Message" type="search" name="a1" id="ab2" class="search" onkeydown="search()" style="width: 810px;margin-bottom: 5px;"/>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="images/send.png" style="height: 46px;width: 46px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
</section>
</main>