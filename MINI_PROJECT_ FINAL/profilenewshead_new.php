...
<?php
    $e=$_SESSION['Name'];
    $box = "SELECT * FROM `news_feed` WHERE `post_id`='$e'";
                    ...
                    <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:170px;">
                            ...
                            <div class="col-lg-14" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                        <div class="col-sm-3">
                                            <p class="mb-0" style="color: black;font-size:15px;"><b>Caption</b></p>
                                        </div>
                                            <?php
                                                    echo '<div class="col-sm-9">
                                                    <p class="text-muted mb-0" style="color: black;font-size:15px;">Be live with us</p></div>';
                                            ?>                                            
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <?php
                                ...
                                {   $result= $_SESSION['allresults'];
                                    ...
                                    {    echo '<div class="row g-2">
                                                <div class="col mb-2">
                                                    <img src="./news_feed/'.$row[1].'" alt="image 1" class="w-100 rounded-3">
                                                </div>
                                            </div>';
                                    }
                                }
