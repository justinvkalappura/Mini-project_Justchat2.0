        ...
        if(password.match(pattern)){
           ...
           isValid=false;
            ...
            document.getElementById("validatepwd").innerHTML="Invalid password";
           isValid=false;
        }
        return isValid;
        ...
        function validateconfirmPassword(){
         ...
         if(cpassword!=password){
            ...
            document.getElementById("validateconfirmPassword").innerHTML="Password Required";
            isValid=false;
         }
         else{
    ...
    function search() {
        if(Event.keyCode == 13) {
            ...
            window.open('search_home.php','_self');
        }
    }
